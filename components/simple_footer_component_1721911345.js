                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            <img id="footer-logo" src="https://makeinfinite-mentat-test.azurewebsites.net/get_image/Cricket_App_1721911344/logo.svg" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                            CricketMate - Your Ultimate Cricket Companion
                        </a>
                    </div>
                </div>
                <div class="flex">
